                            ...
                            function(uri) {
                                ...
                                if(req.body.homepageMain==='true'){
                                    console.log('in homepage if video')
                                     HealthCareVideo.updateMany({homepageMain:true},{"$set":{"homepageMain": false}}).catch(err=>console.log(err))
                                }
                            ...
                            let file_name = `./public/images/healthcare/${fileInfoVideo.filename}`
                                await client.upload(
                                    ...
                                    function(uri) {
                                        ...
                                        HealthCareVideo.updateOne({ _id: mongoose.Types.ObjectId(req.params.id) },
                                                data
                                            )
                                            .then((response) => {
            ...
            if (health) {
                HealthCareVideo.deleteOne({ _id: req.params.id })
                    .then(async(_) => {
                        ...
                        axios.delete(`https://api.vimeo.com/videos/${health.video}`,
                        config
                        )
